                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            MyText(title:
                              "${Utils.checkIfUrduLocale() ? "": "lbl_rs".tr}${item.price.toStringAsFixed(2)}${!Utils.checkIfUrduLocale() ? "": "lbl_rs".tr}",
                              fontWeight: FontWeight.bold,
                            ),
                          ],
                        ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          MyText(title:
            "${Utils.checkIfUrduLocale() ? "": "lbl_rs".tr}${amount.toStringAsFixed(2)}${!Utils.checkIfUrduLocale() ? "": "lbl_rs".tr}",
              fontSize: fontSize,
              fontWeight: isBold ? FontWeight.bold : FontWeight.normal,
          ),
        ],
